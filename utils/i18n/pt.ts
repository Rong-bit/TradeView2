...
export const pt: Translations = {
  ...
  dashboard: {
    ...
    mergedDisplay: 'Agrupado',
    detailedDisplay: 'Por conta',
    aiUpdatePrices: 'Atualizar preços',
  ...
  dividendTax: {
    ...
    pendingActualDripHint: 'Para Reinvestimento de dividendos (DRIP), vá a « Histórico » e toque em « + Adicionar registro » — não clique em « Adicionar » aqui.',
  ...
  holdings: {
    ...
    marketValue: 'Valor',
    profitLoss: 'L/P',
    annualizedROI: 'Rent. anual',
    dailyChange: 'Var. diária',
    avgPrice: 'Preço méd.',
...
- É recomendado referir-se a cotações em tempo real fornecidas por empresas de valores mobiliários ou instituições financeiras.`,
  ...
  historicalModal: {
    ...
    periodDataTitle: 'Dados {year} Q{quarter}',
    exchangeRateLabel: 'Taxa (USD/TWD):',
    colMarket: 'Mercado',
    colTicker: 'Símbolo',
    colClosePrice: 'Fecho ({date})',
    colClosePriceShort: 'Fecho',
