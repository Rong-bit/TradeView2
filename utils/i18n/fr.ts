...
export const fr: Translations = {
  ...
  dashboard: {
    ...
    mergedDisplay: 'Regroupé',
    detailedDisplay: 'Par compte',
    aiUpdatePrices: 'MAJ cours (IA)',
  ...
  dividendTax: {
    ...
    pendingActualDripHint: 'Pour le Réinvestissement des dividendes (DRIP), allez dans « Historique » et appuyez sur « + Ajouter un enregistrement » — n\'appuyez pas sur « Ajouter » ici.',
  ...
  holdings: {
    ...
    marketValue: 'Valeur',
    profitLoss: 'G/P',
    annualizedROI: 'Rend. ann.',
    dailyChange: 'Var. jour',
    avgPrice: 'Prix moy.',
...
- Il est recommandé de se référer aux cotations en temps réel fournies par les sociétés de valeurs mobilières ou les institutions financières.`,
  ...
  historicalModal: {
    ...
    periodDataTitle: 'Données {year} Q{quarter}',
    exchangeRateLabel: 'Taux (USD/TWD) :',
    colMarket: 'Marché',
    colTicker: 'Symbole',
    colClosePrice: 'Clôture ({date})',
    colClosePriceShort: 'Clôture',
